					...
					<div class="row">
                         ...
                         <section id="content" class="container">
							...
							<form name="frmreservadatos" role="form" action="reserva-finalizar.php" method="post">
								...
								<p><input type="text" name="direccion" id="direccion" placeholder="Dirección" size="60"></p>
								<p><input type="text" name="cp" id="cp" placeholder=" C.P."  size="60"></p>
								<p><input type="text" name="provincia" id="provincia" placeholder="Provincia"  size="60"></p>
								<p><input type="text" name="poblacion" id="poblacion" placeholder="Población"  size="60"></p>
								...
								<p><input type="text" name="observaciones" id="observaciones" placeholder="Observaciones - Número jugadores"  size="60"></p>
