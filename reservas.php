		...
		<div id="main-wrapper">
			...
			<div id="intro" class="container">
				<div id="footer" class="container">
					<a href="#" class="image image-bank"><img src="images/Bank_transparente_p.webp" alt=""></a>
					<header>
						<h2>HORARIOS</h2>
					</header>
									...
									if (in_array($diasemana, $aDiassemana)){
										...
										if(count($reserva)>0){
											...
											<li><span><strong><?php
												echo $salahora->hora
												?>
												</strong> <em>Ocupado</em></span></li> 
										<?}else{?>
											<li><a href="#" class="reservahora" data="<?php
											echo "1_".date("d-m-Y")."_".$salahora->hora?>
											"><strong><?echo $salahora->hora?></strong> <em>Libre</em></a></li> 
										<?}?>
									<?}
								}
							}
			...
			<p style="text-align: center">Para reservar alguno de nuestros otros juegos, contacte por teléfono en el 983 103 808</p>
			<div id="intro" class="container">			

			    <div class="row">
					<section class="6u 12u(mobile)">
						<a href="hall-escape.php" class="image image-log"><img src="images/LogoBoomkert.webp" alt=""></a>
						<p> 
						BOOMKER es un juego Hall Escape con versiones para niños a partir de 10 años y para adultos, a partir de 16,
						para un máximo de 20 jugadores.			
						</p>
					</section>
					<section class="6u 12u(mobile)">
						<a href="hall-escape.php" class="image image-log"><img src="images/Pandora.webp" alt=""></a>
						<p> La Caja de Pandora es un juego Hall Escape de una duración aproximada de 75 minutos, para todas las edades, con versión para niños a partir de 10 años y de adultos, a partir de 15,
						para un máximo de 20 jugadores.
						</p>
                	</section>
				</div>
