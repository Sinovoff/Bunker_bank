...
if ($_POST['OK']=="1"){
	...
	// Si autoriza, guarda en la BD Correos
	if ($_POST['CheckAutoriza']==true){ 
			$botonAutoriza=1;
			require_once("autoriza.php");
		}else{ 
			$botonAutoriza=0;
		}
	$reserva->autoriza		= utf8_decode(addslashes($botonAutoriza));	
	//$reserva->jugadores		= utf8_decode(addslashes($jugadores));	
...
/* 
	if($TOTAL>0){
      ...
      */
        ...
        $detalle.="direccion: ".$reserva->direccion."<br>";	
        $detalle.="cp: ".$reserva->cp."<br>";		   
        $detalle.="poblacion: "	.$reserva->poblacion."<br>";		
        $detalle.="provincia: "	.$reserva->provincia."<br>";	
        $detalle.="paise_id: "	.$reserva->paise_id."<br>";	
        $detalle.="telefono	: "	.$reserva->telefono."<br>";    	
        $detalle.="email: "	.$reserva->email."<br>";		
        $detalle.="observaciones: "	.$reserva->observaciones."<br>";	

		$detalle.="<p><strong>FORMA DE PAGO:</strong> GRATUITO</p>";	
	    $detalle.="Casilla CheckAutoriza : "	.$_POST['CheckAutoriza']."<br>";			
        $detalle.="Casilla Acepto : "	.$botonAutoriza."<br>";	
		$detalle.="Casilla Leido : "	.$_POST['terminos1']."<br>";	
